...
const ReviewCard = ({productReviews}) => {
  ...
  return (
    <div className='my-6 bg-white p-8'>
                                ...
                                <div key={index} className='mt-4'>
                                    <div className='flex gap-4 items-center'>
                                        ...
                                        <div className='space-y-1'>
                                            ...
                                            <p
                                            className='text-[12px] italic'>{formatDate(review?.updatedAt)}</p> 
                                            <RatingStars rating={review?.rating}/>
                                        </div>
                                    </div>
                                    <div className='text-gray-600 border p-8'>
        ...
        {/* review modal */}
        <PostAReview isModalOpen={isModalOpen} handLeClose={handleOpenReviewModal}/>
    </div>
  )
}
